...
class NoGKernel():
    # Find out how many vertex and edge labels exist in the graph list (l)
    # Every graph g is mapped to a vector v.g of length l which
    # counts the number of vertex and edge labels.
    # k_NoG = k_rbf( v.g1, v.g2 )
